 ...
 */
public class SherlockProgressGridFragment extends SherlockFragment {
    ...
    public SherlockProgressGridFragment() {
    }
     ...
     * behavior of SherlockProgressGridFragment. In particular, this is currently the only
    ...
    /**
     * The default content for a SherlockProgressGridFragment has a TextView that can
     ...
     * behavior of SherlockProgressGridFragment is to start with the grid not being shown, only
