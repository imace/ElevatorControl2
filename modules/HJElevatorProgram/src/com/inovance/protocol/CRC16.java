...
public class CRC16 {
	public static final int[] crc16_ccitt_table = { 0x0000, 0xc0c1, 0xc181,
	 ...
	 * 获取CRC16
	 */
	public static int GetCrc16(byte[] pData, int uSize)
	{
		if(pData.length == 0)
			return 0;
		...
		{
			crc_value=(crc_value>>8)^crc16_ccitt_table[(crc_value ^ pData[i]) & 0xff];
		}
